...
def score(key, prediction, verbose=False):
    ...
    # micro scores is calculated without consiering "no_relation" class
    ...
    print("only_non_relation:", float(sum(only_non_relation.values())))
    print( "Precision (micro): {:.3%}".format(prec_micro) )
    print( "   Recall (micro): {:.3%}".format(recall_micro) )
    print( "       F1 (micro): {:.3%}".format(f1_micro) )

    acc = accuracy_score(key, prediction)
